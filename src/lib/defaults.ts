...
export const defaultConfig: SiteConfig = {
  ...
  stats: [
    { valor: 53,     etiqueta: "Años de Experiencia",  prefijo: "+", sufijo: "", icono: "Trophy" },
    { valor: 400000, etiqueta: "Servicios Realizados", prefijo: "+", sufijo: "", icono: "Wrench" },
    { valor: 5000,   etiqueta: "Clientes Satisfechos", prefijo: "+", sufijo: "", icono: "Users"  },
  ],
  legalPages: {
    ...
    devoluciones: `1. Condiciones de Devolución\nAceptamos devoluciones de productos en su empaque original no abierto dentro de los primeros 7 días luego de la compra.\n\n2. Productos No Retornables\nNo se aceptan devoluciones de productos ya instalados, abiertos, o que hayan sido usados.\n\n3. Proceso de Devolución\nPara procesar una devolución, contáctanos a través de WhatsApp con tu comprobante de compra.\n\n4. Reembolsos\nLos reembolsos se procesarán dentro de los 5 días hábiles siguientes a la recepción y verificación del producto devuelto.\n\n5. Garantía de Servicios\nNuestros servicios de mano de obra tienen garantía de 30 días. Si el problema persiste, lo solucionamos sin costo adicional.`,
  },
};
